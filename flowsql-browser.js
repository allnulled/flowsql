...
async function() {
  ...
  return matchedRows[0] || null;
    ...
    FlowsqlBrowser.prototype.selectByTags = function(table, tags) {
...
function(base64) {
  ...
  return true;
        ...
        FlowsqlBrowser.FileSystem.prototype.renameFile = function(filepath, newFilepath) {
  ...
  return this.$flowsql.updateOne(this.$table, row.id, {
    [this.$options.columnForPath]: newpath
        ...
        FlowsqlBrowser.FileSystem.prototype.renameDirectory = function(dirpath, newDirpath) {
  ...
  return this;
        ...
        FlowsqlBrowser.Firewall.Flowsql = FlowsqlBrowser;
        FlowsqlBrowser.Firewall.AssertionError = FlowsqlBrowser.AssertionError.bind(FlowsqlBrowser);
        FlowsqlBrowser.Firewall.defaultOptions = {

};
        FlowsqlBrowser.Firewall.assertion = FlowsqlBrowser.assertion.bind(FlowsqlBrowser);
        
        FlowsqlBrowser.Firewall.prototype.assertion = FlowsqlBrowser.prototype.assertion.bind(FlowsqlBrowser);
        FlowsqlBrowser.Firewall.prototype.setSource = function() {
